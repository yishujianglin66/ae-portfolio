...
// - 694种系统字体精选分类
// - AE内置200+文字动画预设(.ffx)
// - 多层文字特效:描边/发光/投影/RGB分离/渐变/3D
// - 8种动画风格 + 4种入场 + 4种出场
//
// V9文字系统:
// 1. presetFFX    - 直接应用AE内置.ffx预设
// 2. cinematicBold- 电影级粗体字(多层描边+外发光+投影)
// 3. epic3D       - 史诗3D文字(3D层+景深+旋转)
// 4. neonGlow     - 霓虹发光风格
// 5. grunge       - 粗糙故障风格
// 6. elegant      - 优雅衬线风格
// 7. techDigital  - 科技数字风格
// 8. brushStroke  - 笔刷手写风格
// ============================================================

var COMP_NAME = "VinlandSaga_Battle_V9";
