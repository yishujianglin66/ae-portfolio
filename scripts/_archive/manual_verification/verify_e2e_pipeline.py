...
运行方式：
    python scripts/manual_verification/verify_e2e_pipeline.py
    python scripts/manual_verification/verify_e2e_pipeline.py --audio path/to/audio.mp3
...
for _sub in ("audio", "analysis", "ae", "core", "pipeline"):
