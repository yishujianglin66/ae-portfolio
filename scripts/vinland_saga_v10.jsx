...
//
// 集成三大VideoCopilot插件:
// 1. Saber (VC SABER) - 能量光效文字/霓虹描边/光剑
// 2. Optical Flares (VC Optical Flares) - 镜头光晕/漏光/能量爆发
// 3. Twitch (Videocopilot Twitch) - 故障抖动/卡点/转场
//
// 保留V9全部文字系统(8风格+8动画+字体预设库)
// 新增:
// - Saber文字层光效(Core Type=Text Layer)
// - Optical Flares音频驱动光晕
// - Twitch故障效果(6大operator)
// - 音频驱动的插件参数联动
// ============================================================

var COMP_NAME = "VinlandSaga_Battle_V10";
