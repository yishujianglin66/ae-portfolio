...
console.log('✅ 导入素材命令已发送');
console.log('');
console.log('📄 素材路径:', testImage);
console.log('');
console.log('💡 请检查 AE 项目面板，应该看到 test_image.png 素材');
console.log('');
console.log('='.repeat(70));
console.log('');
console.log('完成这步后，我们将进行步骤 3/3: 导入素材到合成');
