...
var COMP_NAME = "VinlandSaga_Cinematic_V15";

// V15: 构建版 - 只创建合成和保存工程，不自动渲染
var OUTPUT_PATH = "D:/AE-Work/output/";
var OUTPUT_FILE = "VinlandSaga_Battle_V15.mp4";
var AUTO_RENDER = false;  // V15: 关闭自动渲染，用 aerender 单独渲染
...
function main() {
    try {
        ...
        return JSON.stringify({
            ...
            technique: "Cinematic V15 - 5 Lens Languages",
            version: "V15",
...
function applyThreeLayerGrading(comp) {
    // V13.5补偿: LUT 文件存在性检查
    var lutPath = LUT_CREATIVE + "Kodak 5218 Kodak 2383 (by Adobe).cube";
