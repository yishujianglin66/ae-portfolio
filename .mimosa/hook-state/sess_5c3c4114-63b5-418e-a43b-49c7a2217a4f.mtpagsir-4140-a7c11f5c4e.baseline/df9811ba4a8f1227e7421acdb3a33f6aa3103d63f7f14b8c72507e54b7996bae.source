...
function applyThreeLayerGrading(comp) {
    ...
    try {
        ...
        // V14: RGB曲线增强电影感
        try {
            var curves = lumetri.property("Curves");
            var masterCurve = curves.property("Master");
            masterCurve.setValue([
                [0, 0], [40, 35], [80, 82], [120, 125], [160, 165], [200, 200], [240, 245], [255, 255]
            ]);
            var redCurve = curves.property("Red");
            redCurve.setValue([
                [0, 0], [60, 50], [120, 125], [180, 185], [255, 255]
            ]);
            var blueCurve = curves.property("Blue");
            blueCurve.setValue([
                [0, 0], [60, 70], [120, 125], [180, 180], [255, 255]
            ]);
        } catch(e) {}
    } catch(e) {}
    ...
    for (var si = 0; si < SEGMENTS.length; si++) {
        var seg = SEGMENTS[si];
        try {
            // V14: 段落级色调 - 使用 Lumetri Color Wheels
            ...
            var segLumetri = segAdj.property("Effects").addProperty("ADBE Lumetri Color");
            
            if (seg.name === "Intro") {
                segLumetri.property("Shadows").setValue([-0.15, 0.05, 0.25, 0]);
                segLumetri.property("Midtones").setValue([-0.1, 0.02, 0.15, 0]);
                segLumetri.property("Highlights").setValue([-0.05, 0.01, 0.1, 0]);
            } else if (seg.name === "Build") {
                segLumetri.property("Shadows").setValue([0.1, 0.05, -0.15, 0]);
                segLumetri.property("Midtones").setValue([0.15, 0.1, -0.1, 0]);
                segLumetri.property("Highlights").setValue([0.2, 0.15, -0.05, 0]);
            } else if (seg.name === "Drop") {
                segLumetri.property("Shadows").setValue([0.2, 0.02, -0.2, 0]);
                segLumetri.property("Midtones").setValue([0.25, -0.05, -0.25, 0]);
                segLumetri.property("Highlights").setValue([0.15, -0.1, -0.15, 0]);
            } else if (seg.name === "Break") {
                segLumetri.property("Shadows").setValue([-0.2, 0.02, 0.3, 0]);
                segLumetri.property("Midtones").setValue([-0.15, 0.05, 0.2, 0]);
                segLumetri.property("Highlights").setValue([-0.1, 0.02, 0.12, 0]);
            } else {
                segLumetri.property("Shadows").setValue([-0.08, 0.03, 0.15, 0]);
                segLumetri.property("Midtones").setValue([0.05, 0.08, -0.05, 0]);
                segLumetri.property("Highlights").setValue([0.1, 0.12, -0.08, 0]);
            }
...
function applyPreciseCyanOrange(comp) {
    try {
        ...
        var lumetri = adj.property("Effects").addProperty("ADBE Lumetri Color");
        
        var hsl1 = lumetri.property("HSL Secondary").addProperty("HSL Qualifier");
        hsl1.property("Hue").setValue([25, 55]);
        hsl1.property("Sat").setValue([20, 100]);
        hsl1.property("Lum").setValue([15, 90]);
        hsl1.property("Feather").setValue([10, 10, 10]);
        hsl1.property("Hue Shift").setValue(0);
        hsl1.property("Sat").setValue(20);
        hsl1.property("Lum").setValue(10);
        
        var hsl2 = lumetri.property("HSL Secondary").addProperty("HSL Qualifier");
        hsl2.property("Hue").setValue([180, 240]);
        hsl2.property("Sat").setValue([10, 100]);
        hsl2.property("Lum").setValue([0, 40]);
        hsl2.property("Feather").setValue([15, 15, 15]);
        hsl2.property("Hue Shift").setValue(0);
        hsl2.property("Sat").setValue(25);
        hsl2.property("Lum").setValue(-5);
        
        var hsl3 = lumetri.property("HSL Secondary").addProperty("HSL Qualifier");
        hsl3.property("Hue").setValue([0, 360]);
        hsl3.property("Sat").setValue([0, 100]);
        hsl3.property("Lum").setValue([0, 100]);
        hsl3.property("Feather").setValue([5, 5, 5]);
        hsl3.property("Invert").setValue(true);
        hsl3.property("Hue Shift").setValue(-10);
        hsl3.property("Sat").setValue(15);
        
        adj.opacity.setValue(85);
    } catch(e) {}
}
