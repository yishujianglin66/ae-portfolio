...
class ModelConfig:
    ...
    CLAUDE_FAST = os.environ.get("DUCK_MISS_FAST_MODEL", "claude-haiku-4-5-20251001")
    ...
    GPT_DEFAULT = os.environ.get("GPT_GATEWAY_DEFAULT_MODEL", "gpt-5.5")
    GPT_FAST = os.environ.get("GPT_GATEWAY_FAST_MODEL", "gpt-5.4-mini")
    GPT_CODE = os.environ.get("GPT_GATEWAY_CODE_MODEL", "gpt-5.6-luna")
